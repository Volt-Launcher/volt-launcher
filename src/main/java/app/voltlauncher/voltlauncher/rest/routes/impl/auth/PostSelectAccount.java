...
@Route(path = "/api/accounts/{uuid}/select", method = MethodType.POST)
public class PostSelectAccount implements IRoute {
    private final MicrosoftAuth msAuth;

    public PostSelectAccount(MicrosoftAuth msAuth) {
        this.msAuth = msAuth;
    }
